...
try:
    ...
    model, scaler = None, None  # Handle loading failure gracefully
...
def predict():
    ...
    for _ in range(num_of_days):
        ...
        # Convert the predicted price to a float for JSON serialization
...
if __name__ == '__main__':
    port = int(os.environ.get('PORT', 5000))  # Specify the port for deployment
